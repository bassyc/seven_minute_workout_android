...
public class WorkoutListFragment extends ListFragment {
    ...
    /**
     * Whether or not the application is in TwoPane mode
     */
    private boolean mTwoPane = false; // false by default, we actually check in onResume
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new WorkoutListAdapter(getActivity(), WorkoutContent.WORKOUTS));
    }
    ...
    public void onResume() {
        ...
        if (mTwoPane && (mActivatedPosition != ListView.INVALID_POSITION)) {
            mCallbacks.onItemSelected(mActivatedPosition);
        }

        // Remove 'activated state' when in single pane mode
        if (!mTwoPane) {
